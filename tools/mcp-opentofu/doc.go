// Mcp-opentofu is an MCP server (stdio transport) that exposes five tools:
// search_registry, get_provider_details, get_module_details, get_resource_docs,
// and get_datasource_docs.
//
// All five tools talk to https://api.opentofu.org over HTTPS and return either
