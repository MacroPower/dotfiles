...
func TestAddTool(t *testing.T) {
	...
	require.NotPanics(t, func() {
		...
		mcp.AddTool(srv, &mcp.Tool{Name: toolRunInit, Description: "x"}, h.handleInit)
		mcp.AddTool(srv, &mcp.Tool{Name: toolRunValidate, Description: "x"}, h.handleValidate)
		mcp.AddTool(srv, &mcp.Tool{Name: toolRunTest, Description: "x"}, h.handleTest)
	})
}
