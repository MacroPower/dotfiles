...
const registryInfoText = `The OpenTofu MCP server exposes the public OpenTofu Registry for searching and reading documentation about providers, modules, resources, and data sources.
You can:
