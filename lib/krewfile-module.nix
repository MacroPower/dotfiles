# Local patched copy of krewfile's hm-module.nix
# Fixes unescaped quotes in literalExpression on line 40
# TODO: remove once https://github.com/brumhard/krewfile is fixed upstream
self:
{
  config,
  lib,
