...
* **Environment variable**: [`TASK_VERBOSE`](./config.md#task-verbose)
...
* **Environment variable**: [`TASK_SILENT`](./config.md#task-silent)
...
* **Environment variable**: [`TASK_DISABLE_FUZZY`](./config.md#task-disable-fuzzy)
...
* **Environment variable**: [`TASK_FAILFAST`](./config.md#task-failfast)
...
* **Environment variable**: [`TASK_DRY`](./config.md#task-dry)
...
* **Environment variable**: [`TASK_CONCURRENCY`](./config.md#task-concurrency)
...
* **Environment variable**: [`TASK_COLOR`](./config.md#task-color)
...
* **Environment variable**: [`TASK_ASSUME_YES`](./config.md#task-assume-yes)
...
* **Environment variable**: [`TASK_INTERACTIVE`](./config.md#task-interactive)
